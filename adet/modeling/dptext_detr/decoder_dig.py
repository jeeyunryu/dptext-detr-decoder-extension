...
from .transformer_layer_dig import (
...
class TFDecoder(BaseDecoder):
    ...
    def _attention(self, trg_seq, tgt_lens, src, src_mask=None, cls_query_attn_maps=None, trg_word_emb=None):
        ...
        #     print(f"🚨 NaN detected in output: {output}!")
        #     import sys;sys.exit()
    ...
    def forward_train(self, feat, out_enc, targets, tgt_lens, img_metas, cls_query_attn_maps, trg_word_emb): # targets는 GT임..
        """
        Args:
            feat (None): Unused.
        ...
        query_targets = torch.cat([init_query, targets], dim=-1)[:, :-1] # 여기 처럼 character query 가 들어가면 될 것 같음
